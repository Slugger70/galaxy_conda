...
this_program_name="galaxy_conda-test.sh"
...
${this_program_name}: run integration/regression tests for galaxy_conda 

Usage:
    ${this_program_name} [-h] [-v] -p program -d test_data_dir 

Example:
    ${this_program_name} -p bin/galaxy_conda -d data/tests
