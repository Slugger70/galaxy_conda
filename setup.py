...
setup(
    name='galaxy_conda-py',
    version='0.1.0.0',
    author='Bernie Pope',
    author_email='bjpope@unimelb.edu.au',
    packages=['galaxy_conda'],
    package_dir={'galaxy_conda': 'galaxy_conda'},
    entry_points={
        'console_scripts': ['galaxy_conda-py = galaxy_conda.galaxy_conda:main']
    },
    url='https://github.com/bjpop/galaxy_conda',
    license='LICENSE',
